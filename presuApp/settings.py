"""
Django settings for presuApp project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-clave-falsa-desarrollo')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'presuApp.context_processors.contador_alertas',
            ],
        },
    },
]

WSGI_APPLICATION = 'presuApp.wsgi.application'
...
# Permite que cualquier origen se conecte (útil para probar desde emulador Android/iOS)
CORS_ALLOW_ALL_ORIGINS = True 

# --- CONFIGURACIÓN JWT (Tokens) ---
